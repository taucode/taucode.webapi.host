...
{
    public abstract class WithIdAndContentResultBase<T> : IActionResult
    {
        ...
        //protected WithIdAndContentResultBase(
        ...
        //protected abstract IActionResult CreateInnerResponse(T content);
